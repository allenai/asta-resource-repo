...
echo -e "     --tags=\"example\""
echo ""
echo -e "${BLUE}3. Use with Claude Code:${NC}"
echo -e "   ${YELLOW}Recommended:${NC} Use the Asta Documents skill"
echo -e "   Location: $INSTALL_DIR/.claude/commands/asta-documents.md"
echo ""
echo -e "   ${GREEN}Usage in Claude Code:${NC}"
echo -e "   💬 \"Use /asta-documents to add a document...\""
echo -e "   💬 \"Use /asta-documents to search for...\""
echo ""
echo -e "   The skill provides complete document management via CLI."
echo -e "   No MCP server configuration needed!"
echo ""
echo -e "${BLUE}4. Read the documentation:${NC}"
echo -e "   README:       $INSTALL_DIR/README.md"
echo -e "   Skill Guide:  $INSTALL_DIR/.claude/commands/asta-documents.md"
echo -e "   MCP Setup (deprecated): $INSTALL_DIR/MCP_SETUP.md"
echo ""
